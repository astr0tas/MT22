...
class MT22Parser ( Parser ):
    ...
    class Type_vardecl_no_exprContext(ParserRuleContext):
        ...
        def accept(self, visitor:ParseTreeVisitor):
            if hasattr( visitor, "visitType_vardecl_no_expr" ):
                return visitor.visitType_vardecl_no_expr(self)
            else:
                return visitor.visitChildren(self)
    ...
    class Type_vardecl_with_exprContext(ParserRuleContext):
        ...
        def accept(self, visitor:ParseTreeVisitor):
            if hasattr( visitor, "visitType_vardecl_with_expr" ):
                return visitor.visitType_vardecl_with_expr(self)
            else:
                return visitor.visitChildren(self)
    ...
    class Array_expression_list1Context(ParserRuleContext):
        ...
        def accept(self, visitor:ParseTreeVisitor):
            if hasattr( visitor, "visitArray_expression_list1" ):
                return visitor.visitArray_expression_list1(self)
            else:
                return visitor.visitChildren(self)
    ...
    class Array_expression1Context(ParserRuleContext):
        ...
        def accept(self, visitor:ParseTreeVisitor):
            if hasattr( visitor, "visitArray_expression1" ):
                return visitor.visitArray_expression1(self)
            else:
                return visitor.visitChildren(self)
    ...
    class Array_expression_list2Context(ParserRuleContext):
        ...
        def accept(self, visitor:ParseTreeVisitor):
            if hasattr( visitor, "visitArray_expression_list2" ):
                return visitor.visitArray_expression_list2(self)
            else:
                return visitor.visitChildren(self)
    ...
    class Array_expression2Context(ParserRuleContext):
        ...
        def accept(self, visitor:ParseTreeVisitor):
            if hasattr( visitor, "visitArray_expression2" ):
                return visitor.visitArray_expression2(self)
            else:
                return visitor.visitChildren(self)
    ...
    class Arraydecl_with_exprContext(ParserRuleContext):
        ...
        def accept(self, visitor:ParseTreeVisitor):
            if hasattr( visitor, "visitArraydecl_with_expr" ):
                return visitor.visitArraydecl_with_expr(self)
            else:
                return visitor.visitChildren(self)
    ...
    class Arraydecl_no_exprContext(ParserRuleContext):
        ...
        def accept(self, visitor:ParseTreeVisitor):
            if hasattr( visitor, "visitArraydecl_no_expr" ):
                return visitor.visitArraydecl_no_expr(self)
            else:
                return visitor.visitChildren(self)
    ...
    class Vardecl_with_exprContext(ParserRuleContext):
        ...
        def accept(self, visitor:ParseTreeVisitor):
            if hasattr( visitor, "visitVardecl_with_expr" ):
                return visitor.visitVardecl_with_expr(self)
            else:
                return visitor.visitChildren(self)
    ...
    class Vardecl_no_exprContext(ParserRuleContext):
        ...
        def accept(self, visitor:ParseTreeVisitor):
            if hasattr( visitor, "visitVardecl_no_expr" ):
                return visitor.visitVardecl_no_expr(self)
            else:
                return visitor.visitChildren(self)
